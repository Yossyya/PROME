            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden group-hover:block z-20 group-focus-within:block">
                <div className="space-y-2 py-2">
                  ...
                  <Link to="/primaria" className="block px-4 py-2 text-letter hover:bg-gray-100">PRIMARIA</Link>
                  <Link to="/secundaria" className="block px-4 py-2 text-letter hover:bg-gray-100">SECUNDARIA</Link>
                  <Link to="/preparatoria" className="block px-4 py-2 text-letter hover:bg-gray-100">PREPARATORIA</Link>
                </div>
              </div>
            </div>
