            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto px-5 py-24">
                    ...
                    <div className="grid gap-12">
                        ...
                        <div className="flex flex-wrap bg-white rounded-lg overflow-hidden shadow-lg">
                            <div className="w-full md:w-1/2 bg-red-700 p-12 flex flex-col justify-center text-white">
                                <h2 className="text-2xl font-semibold mb-6">Certificación Cambridge Esol</h2>
                                <p className="leading-relaxed mb-10">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eleifend, arcu eget viverra efficitur, orci ipsum tincidunt tortor, at convallis orci felis at libero. Sed scelerisque vel odio ac tristique.
                                </p>
                                <a href="https://www.cambridgeenglish.org/es/" className="inline-flex items-center px-6 py-2 text-white bg-red-700 font-semibold rounded border-2 border-white hover:text-red-700 hover:bg-white transition duration-300 mx-auto">
                                    SABER MÁS...
                                </a>
                            </div>
                            <div className="w-full md:w-1/2 flex justify-center items-center">
                                <img src={cam} alt="Cambridge" className="object-contain w-full h-80 md:h-96" />
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="w-full h-60 object-cover object-center" src={ana} alt="blog" />
                                <div className="p-6">
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">UNIVERSIDAD ANAHUAC</h1>
                                    ...
                                    <div className="flex items-center flex-wrap">
                                        <a
                                            ...
                                            className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 underline hover:no-underline"
                                        >
                                            Saber Más ...
                                        </a>
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="w-full h-60 object-cover object-center" src={las} alt="blog" />
                                <div className="p-6">
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">UNIVERSIDAD LA SALLE</h1>
                                    <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                                    <div className="flex items-center flex-wrap">
                                        <a
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="w-full h-60 object-cover object-center" src={udla} alt="blog" />
                                <div className="p-6">
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">UNIVERSIDAD DE LAS AMERICAS PUEBLA</h1>
                                    <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                                    <div className="flex items-center flex-wrap">
                                        <a
